...
class transactionsOwner extends StatefulWidget {
  const transactionsOwner({Key? key}) : super(key: key);

  @override
  State<transactionsOwner> createState() => _transactionsState();
}

class _transactionsState extends State<transactionsOwner> {
                                                    ...
                                                    return  entryList[index].value["RequestStatus"] == "Approved" ||  entryList[index].value["RequestStatus"] == "Declined" ? Column(
                                                        children: [
                                                          ElevatedButton(
                                                            ...
                                                            Navigator.pushReplacementNamed(context, '/transactionDetailsOwner', arguments: {
