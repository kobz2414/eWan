...
class transactionDetailsOwner extends StatefulWidget {
  const transactionDetailsOwner({Key? key}) : super(key: key);

  @override
  _transactionDetailsState createState() => _transactionDetailsState();
}

class _transactionDetailsState extends State<transactionDetailsOwner> {
                            ...
                            Container(
                              child: Row(
                                ...
                                children: [
                                  ElevatedButton(
                                      onPressed: (){
                                        Navigator.pushReplacementNamed(context, '/transactionsOwner', arguments: {
