...
class parkingSlotDetailsOwner extends StatefulWidget {
  const parkingSlotDetailsOwner({Key? key}) : super(key: key);

  @override
  _showParkingSlotDetailsState createState() => _showParkingSlotDetailsState();
}

class _showParkingSlotDetailsState extends State<parkingSlotDetailsOwner> {
