...
class paymentMethodOwner extends StatefulWidget {
  ...
  @override
  State<paymentMethodOwner> createState() => _transactionsState();
}

class _transactionsState extends State<paymentMethodOwner> {
                                                    ...
                                                    return Column(
                                                        children: [
                                                          ElevatedButton(
                                                            ...
                                                            Navigator.pushNamed(context, '/paymentMethodDetailsOwner', arguments: {
              ...
              Container(
                child: Row(
                  ...
                  children: [
                    ElevatedButton(
                        onPressed: (){
                          Navigator.pushNamed(context, '/paymentMethodAddOwner');
                        },
