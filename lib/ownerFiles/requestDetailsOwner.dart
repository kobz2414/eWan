...
class requestDetailsOwner extends StatefulWidget {
  const requestDetailsOwner({Key? key}) : super(key: key);

  @override
  State<requestDetailsOwner> createState() => _requestDetailsState();
}

class _requestDetailsState extends State<requestDetailsOwner> {
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    onPressed: (){
                                      ...
                                      }else if (requestCurrentStatus == "Approved"){
