...
class startPageOwner extends StatefulWidget {

  @override
  State<startPageOwner> createState() => _homePageState();

}

class _homePageState extends State<startPageOwner> {
                              ...
                              Container(
                                width: MediaQuery.of(context).size.width,
                                  child: InkWell(
                                    ...
                                    onTap: () {
                                      Navigator.pushNamed(context, '/parkingLocationOwner');
                                    },
                                  )
                              )
                          ),
                                  ...
                                  child: InkWell(
                                    child: Column(
                                      children: [
                                        ...
                                        Column(
                                          children: const [
                                            Text("ADD A PARKING PLACE", style:
                                            TextStyle(
                                                color: Colors.white,
                                                fontFamily: "Metropolis",
                                                fontWeight: FontWeight.w700
                                    ...
                                    onTap: () {
                                      Navigator.pushNamed(context, '/addParkingPlaceOwner');
                                    },
                                  )
                              )
                          ),
