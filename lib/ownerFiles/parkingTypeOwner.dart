...
class parkingTypeOwner extends StatefulWidget {
  const parkingTypeOwner({Key? key}) : super(key: key);

  @override
  State<parkingTypeOwner> createState() => _parkingTypeState();
}

class _parkingTypeState extends State<parkingTypeOwner> {
